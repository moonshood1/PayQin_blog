...
const Features = () => {
  return (
    <div className="bg-white pt-16 pb-4 ">
      <h1 className="md:pl-44 2xl:pl-72 text-3xl font-bold text-black mb-5">
        Featured Blogs
      </h1>
      <div className="grid md:grid-cols-2 ">
        <div className="md:pl-44 2xl:pl-72">
          <div className="bg-gray-100 h-44 grid grid-cols-3 rounded-lg overflow-hidden hover:shadow-md cursor-pointer">
            ...
            <div className="col-span-2 flex flex-wrap content-center mx-4">
        ...
        <div className="md:pl-2 2xl:pl-2">
